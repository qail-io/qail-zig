...
- Remaining ergonomics gap versus `qail.rs`: much narrower now; the main enterprise-auth delta is the encrypted GSSENC transport rather than the provider/session stack.
