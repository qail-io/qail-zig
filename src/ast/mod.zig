...
pub const Merge = cmd.Merge;
pub const MergeSource = cmd.MergeSource;
pub const MergeMatchKind = cmd.MergeMatchKind;
pub const MergeAssignment = cmd.MergeAssignment;
pub const MergeAction = cmd.MergeAction;
pub const MergeClause = cmd.MergeClause;
